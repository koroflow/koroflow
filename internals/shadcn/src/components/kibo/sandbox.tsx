...
export const SandboxTabsContent = ({ className, value, ...props }: SandboxTabsContentProps) => {
	...
	return (
		<div
			...
			data-state={selectedTab === value ? "active" : "inactive"}
			className={cn(
				"flex-1 overflow-y-auto ring-offset-background transition-opacity duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 min-h-[25rem]",
				selectedTab === value
