...
<Tabs  groupId="manual-install" items={['npm', 'pnpm', 'yarn', 'bun']}>
  <Tab value="npm">npm install @koroflow/dev-tools</Tab>
  <Tab value="pnpm">pnpm install @koroflow/dev-tools</Tab>
  <Tab value="yarn">yarn add @koroflow/dev-tools</Tab>
  <Tab value="bun">bun add @koroflow/dev-tools</Tab>
</Tabs>
