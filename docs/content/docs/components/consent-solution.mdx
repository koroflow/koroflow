...
<Tabs  groupId="shadcn-cli" items={['npm', 'pnpm']}>
  <Tab value="npm">npx shadcn@latest add "https://koroflow.com/r/consent-solution"</Tab>
  <Tab value="pnpm">pnpx shadcn@latest add "https://koroflow.com/r/consent-solution"</Tab>
</Tabs>
...
<Tabs  groupId="manual-install" items={['npm', 'pnpm']}>
  <Tab value="npm">npm install @koroflow/core-react @koroflow/dev-tools</Tab>
  <Tab value="pnpm">pnpm install @koroflow/core-react @koroflow/dev-tools</Tab>
  <Tab value="yarn">yarn add @koroflow/core-react @koroflow/dev-tools</Tab>
  <Tab value="bun">bun add @koroflow/core-react @koroflow/dev-tools</Tab>
</Tabs>
