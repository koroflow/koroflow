...
<ComponentPreview name="privacy-popup-demo" />

## Features

- 🌍 Support for multiple privacy regulations (GDPR, CCPA, LGPD, US State Privacy)
- 🔒 Granular consent management for different cookie types
- 📱 Responsive and customizable UI components
- 🎨 Fully customizable styling with Tailwind CSS
- ⚡ Server-side country detection for regulation compliance
- 🔄 Automatic consent persistence
- 📝 Built-in privacy and cookie policy integration
- 🎯 Event callbacks for tracking user interactions
- 🧩 Multiple UI components (Banner, Dialog, Widget)
...
groupId="shadcn"
  commands={{
    npm: `npx shadcn@latest add "https://koroflow.com/r/privacy-popup"`,
    pnpm: `pnpx shadcn@latest add "https://koroflow.com/r/privacy-popup"`,
  }}
/>
...
<InstallPackagesBlock groupId="manual" commands={{
...
<ComponentSource name="privacy-popup" />
...
<ComponentPreview name="privacy-popup-minimal-demo" defaultTab="Code" />

### Event Callbacks

Track user interactions with the consent system:

<ComponentPreview name="privacy-popup-callback-demo" defaultTab="Code" />
