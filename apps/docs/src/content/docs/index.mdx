...
c15t (short for consent.management) is an open-source platform that transforms privacy consent from a compliance checkbox into a fully observable system. Built for modern development teams, it provides a unified solution for:
...
c15t is built in public with our community. Get involved:
...
Check out our [enterprise offerings](/enterprise) for:
