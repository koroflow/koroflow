...
```tsx
import * as ConsentManagerWidget from '@consent-management/react/consent-manager-widget'
...
### Branding
Control the visibility of consent.management branding:
...
| hideBranding | boolean | Controls consent.management branding visibility | false |
...
```tsx
import { ConsentManagerDialog } from '@consent-management/react/consent-manager'
...
- [Cookie Banner](/docs/frameowkr/react/cookie-banner)
- [Consent Manager Dialog](/docs/frameowkr/react/consent-manager-dialog)
