...
- [Cookie Banner](/docs/framework/react/cookie-banner) - Initial privacy notice
- [Consent Manager Widget](/docs/framework/react/consent-manager-widget) - Detailed controls
