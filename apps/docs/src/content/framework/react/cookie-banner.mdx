...
<Tabs groupId="Version" items={["Recommended", "Expanded"]}>
  ...
  ```tsx 
import { CookieBanner } from "@consent-management/react";
...
<Tab value="expanded">
```tsx
import * as CookieBanner from "@consent-management/react/cookie-banner";
...
- [Consent Manager Widget](/docs/frameowkr/react/consent-manager-widget)
