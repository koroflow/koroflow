...
This package is licensed under the [GNU General Public License v3.0](https://github.com/koroflow/c15t/blob/main/LICENSE).

## Contributing

Contributions are welcome! Please read the [contributing guidelines](https://github.com/koroflow/c15t/blob/main/CONTRIBUTING.md) before submitting a pull request.

## Support

For support, please join our [Discord community](https://discord.gg/koroflow) or open an issue on [GitHub](https://github.com/koroflow/c15t/issues).
