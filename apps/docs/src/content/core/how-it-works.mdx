---
title: How It Works
description: In-depth explanation of the architecture and functionality of the @c15t/core package.
---
## Overview

The `@c15t/core` package is a headless library that provides the foundational logic and state management for privacy consent management. It allows developers to build custom user interfaces while leveraging a robust backend for consent tracking and management.
...
The `@c15t/core` package provides a powerful and flexible solution for managing privacy consents in modern applications. Its headless architecture and robust state management make it an ideal choice for developers looking to build custom consent interfaces while ensuring compliance with privacy regulations. 