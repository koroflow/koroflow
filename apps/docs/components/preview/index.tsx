import {
  ...
  SandboxTabsList,
  SandboxTabsTrigger,
} from '@koroflow/shadcn-ui/components/ui/sandbox';
import {
  ResizableHandle,
  ResizablePanel,
  ResizablePanelGroup,
} from '@koroflow/shadcn-ui/components/ui/resizable';
...
export const Preview = async ({
  ...
  // Load selected Koroflow component
  ...
  files[`/components/ui/korowflow/${name}.tsx`] = parseContent(
    selectedComponentContent
  );

  // Load required dependencies from selected Korowflow component
  ...
  // Load required devDependencies from selected Korowflow component
